...
export default function About() {
    return (
        <section className="bg-[#121212] text-white py-24 md:py-40 px-6 md:px-12" aria-label="About Faiz Jamal">
            <div className="max-w-5xl mx-auto">
                <p className="text-2xl md:text-5xl font-light leading-snug text-gray-200 mb-16">
                    I'm Faiz Jamal, an engineering student turned Generative AI builder with a background in everything from football and gaming to video editing and content creation.
                </p>
